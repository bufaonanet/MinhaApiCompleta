...
namespace DevIO.Api.V1.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public AuthController(INotificador notificar,
                                 SignInManager<IdentityUser> signInManager,
                                 UserManager<IdentityUser> userManager,
                                 IOptions<AppSettings> appSettings,
                                 IUser appUser,
                                 ILogger<AuthController> logger) : base(notificar, appUser)
        {
        ...
        private async Task<LoginResponseViewModel> GerarJWT(string email)
        {
            ...
            var token = tokenHandler.CreateToken(new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddHours(_appSettings.ExpiracaoHora),
            ...
            var response = new LoginResponseViewModel
            {
                ...
                ExpiresIn = TimeSpan.FromHours(_appSettings.ExpiracaoHora).TotalSeconds,
